    ...
    public class PlacedStructure : MonoBehaviour, IDamageable
    {
        ...
        void AttachBehaviour()
        {
            switch (Definition.kind)
            {
                ...
                case StructureKind.Furnace: gameObject.AddComponent<FurnaceStructure>().Bind(this); break;
                case StructureKind.Trap: gameObject.AddComponent<SpikeTrapStructure>().Bind(this); break;
